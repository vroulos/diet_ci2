...
<div class="container-fluid">
	...
	<div class="col-sm-6 col-md-6 col-lg-4">
		...
		<button type="submit" name="submit_program" value="nothing" style="margin-top: 20px; margin-bottom: 20px; margin-left: 50px" class="btn btn-dark" >Υποβολή Γεύματος</button>
	...
	<div class="col-sm-3 col-md-6">
		<div class="form-group" style="margin-left: 50px; width: 300px ">
